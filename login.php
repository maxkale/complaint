...
{
$errMsg = checkLogIn($_POST,$con);
}

function checkLogIn($data,$con){
	if(!empty($data['username'])&&!empty($data['password'])){
		...
		if(mysqli_affected_rows($con)){
			...
			$_SESSION['loggedInUser'] = $temp;
			header('location:index.php');
			return '';
		}else {
	return 'Invalid Creadiantial';
	}
	}else {
			...
			<div class="col-md-6 col-md-offset-3">
				<div class="panel panel-login">
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-12">
								<form id="login-form" method="post" autocomplete="off" action="<?php echo $_SERVER['PHP_SELF']; ?>" role="form" style="display: block;">
